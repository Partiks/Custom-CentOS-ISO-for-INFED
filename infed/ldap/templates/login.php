<?php
/*
$Id: login.php 5786 2016-01-03 10:56:57Z gruberroland $
...
function display_LoginPage($config_object, $cfgMain) {
	...
	?>
		...
		<table align="center" border="0" rules="none" bgcolor="white" class="ui-corner-all">
			<tr><td colspan=2><img src="../graphics/logo.png" width="75px" height="100px" /></td></tr>
			<tr><td colspan=2><b>LDAP Account Manager</b></td></tr>
			<tr>
				<!--td class="loginLogo" style="border-style:none" rowspan="2" WIDTH=100PX>
				</td-->
		...
		<br><br>
			<TABLE style="position:absolute; bottom:10px;" border="0" width="99%">
				...
				<TR>
				<td align="left">INFLIBNET Centre, Infocity, Gandhinagar, Gujarat, INDIA 
					<?PHP
						//if (!isLAMProVersion()) {
