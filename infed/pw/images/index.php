...
#container { text-align: center; width: 500px; margin: 0% auto; }
...
<p class="imagecentre"><a href="http://www.inflibnet.ac.in/" target="_blank"><img src="images/download.png" /></a></p>
<h2 class="form-signin-heading">INFLIBNET OPEN LDAP: CHANGE PASSWORD</h2><hr />
...
<li>You must use a new password, your current password can not be the same as your new password.</li>
      ...
      ?></div><?php
        ...
        <input type="text" class="form-control" placeholder="Username or Email Address" name="username" required />
...
<div class="signin-form">Powered by CentOS, Letsencrypt, LAM and OpenLDAP</div>
</body>
</html>